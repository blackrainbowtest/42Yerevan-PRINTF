...
| `.`  | Ցույց է տալիս թվի ճշտգրտությունը | `%.2f` → `"42.42"` | Բոնուսում քանի որ չունենք `f` այն կիրառում ենք ամբողջ թվերի հետ, այդ դեպքում ինքը ուղղակի տեղադրելու է բացատներ, համալրելու համար անհրաժեշտ երկարությունը |
