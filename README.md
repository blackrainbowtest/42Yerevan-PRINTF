...
# Բոնուսը պարտադիր չէ կատարել միանգամից ամբողջությամբ, այն կարելի է բաժանել մասերի և կատարել մաս մաս:
...
Բոնուսի հատվածը --strict -ով անցնելու համար, եթե նպատակ ունենաք այն նույնպես կատարել, անհրաժեշտ է նախապես ֆունկցիաները գրել այնպես, որ որևէ սխալի դեպքում Ձեր ծրագիրը վերադարձնի -1:
